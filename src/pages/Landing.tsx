...
const Landing: React.FC = () => {
    ...
    return isMobile ? (
    // HTML content for mobile devices
    <ScrollableContentLayout>
        ...
        <div className="flex flex-col p-10 text-justify">
            ...
            <div className="mt-5 flex flex-row items-center">
                ...
                <a className="text-xl text-bold text-black-600 hover:text-blue-500" href="https://doi.org/10.1080/15472450.2020.1858822" target="_blank" rel="noopener noreferrer">Journal Paper</a>
            </div>
            <div className="mt-5 flex flex-row items-center">
                <img src="Ieee_blue.jpg" alt="Journal Icon" className="mr-4 w-10" />
                <a className="text-xl text-bold text-black-600 hover:text-blue-500" href="https://doi.org/10.1109/ITSC45102.2020.9294742" target="_blank" rel="noopener noreferrer">Conference Paper</a>
            </div>
        </div>
    </ScrollableContentLayout>
    ) : (
